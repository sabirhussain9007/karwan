...
import { CheckCircle, Car, MapPin, Shield, Star, Key } from "lucide-react";
    ...
    <div className="flex flex-col bg-stone-950 min-h-screen">
      ...
      <section className="relative h-[60vh] w-full items-center justify-center overflow-hidden bg-stone-950 flex flex-col">
        <div className="absolute inset-0 z-0">
          <Image width={800} height={800} src="https://images.unsplash.com/photo-1549317661-bd32c8ce0be2?auto=format&fit=crop&q=80" 
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 text-center mt-20">
          ...
          >
            ...
            <p className="text-xl text-stone-300 font-serif italic max-w-2xl mx-auto leading-relaxed">
              Travel comfortably at your own pace with our premium fleet and professional drivers
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-stone-950 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 -mt-32 relative z-20">
            {[
              { icon: Car, title: "Premium Fleet", desc: "Well-maintained vehicles from standard to luxury" },
              { icon: Key, title: "Self or Chauffeur", desc: "Drive yourself or hire our professional local drivers" },
              { icon: Shield, title: "Fully Insured", desc: "Comprehensive insurance coverage for peace of mind" }
            ].map((item, idx) => (
              <motion.div 
                key={idx}
          ...
          <div className="mt-32 mb-20">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-serif font-bold text-white mb-4">Our Rental Options</h2>
              <p className="text-stone-400">Select the vehicle or transfer that fits your travel style</p>
            </div>
                ...
                >
                  <div className="p-8 pb-0 flex-1">
                    ...
                    <div className="flex items-baseline gap-2 mb-8">
                      ...
                      <span className="text-stone-500 text-sm font-medium">{pkg.duration.includes("Trip") ? "/ trip" : "/ day"}</span>
                    </div>
      ...
      {showBooking && <BookingModal serviceType="Car Rental" basePrice={selectedPrice} onClose={() => setShowBooking(false)} />}
    </div>
  );
}
